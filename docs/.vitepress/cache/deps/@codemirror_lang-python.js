...
import {
  ...
  combineConfig,
  fromCodePoint
} from "./chunk-KES6M4I2.js";

// ../node_modules/@lezer/python/node_modules/@lezer/common/dist/index.js
...
// ../node_modules/@lezer/python/node_modules/@lezer/lr/dist/index.js
...
// ../node_modules/@lezer/python/node_modules/@lezer/highlight/dist/index.js
var nextTagID = 0;
var Tag = class _Tag {
  /**
  @internal
...
// ../node_modules/@codemirror/lang-python/node_modules/@lezer/common/dist/index.js
...
// ../node_modules/@codemirror/lang-python/node_modules/@lezer/highlight/dist/index.js
var nextTagID2 = 0;
var Tag2 = class _Tag {
  /**
  @internal
...
var Modifier2 = class _Modifier {
  ...
  static get(base, mods) {
    ...
    if (exists)
      return exists;
    let set = [], tag = new Tag2(set, base, mods);
    for (let m of mods)
      m.instances.push(tag);
...
// ../node_modules/@codemirror/lang-python/node_modules/@codemirror/language/dist/index.js
var _a;
...
function topNodeAt(state, pos, side) {
  ...
  if (!topLang || topLang.allowsNesting) {
    for (let node = tree; node; node = node.enter(pos, side, IterMode2.ExcludeBuffers))
      if (node.type.isTop)
        tree = node;
  }
  return tree;
...
function getScope(doc, node) {
  ...
  function def(node2, type) {
    let name3 = doc.sliceString(node2.from, node2.to);
    completions.push({ label: name3, type });
  }
